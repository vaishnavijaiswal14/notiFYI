...
//import 'package:notifyi/about_screen.dart';
import 'package:my_notifyi/login.dart';

class SettingsPage extends StatefulWidget {
  final String email;

  const SettingsPage({Key? key, required this.email})
      : super(key: key);
      ...
      email: 'btbtc21032_vaishnavi@banasthali.in',
        ...
        body: Container(
          decoration: const BoxDecoration(
            color: Colors.white, // Light orange background color // Optional: Add rounded corners
            ...
            children: <Widget>[
              ...
              ListTile(
                ...
                trailing: Switch(
                  ...
                  activeTrackColor:
                      const Color.fromARGB(255, 34, 67, 255), // Set active track color
                  // Set active color
                ),
              ),
