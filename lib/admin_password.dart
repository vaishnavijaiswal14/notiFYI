...
// import 'package:apps/FurtherDetailsPage.dart';
// import 'package:apps/VerificationPage.dart';
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: Color.fromARGB(255, 22, 25, 149),
         iconTheme: IconThemeData(color: Colors.white), // Set title bar color to blue
      ),
      body: Padding(
        ...
        child: Column(
          ...
          children: [
           ...
           // mainAxisAlignment : MainAxisAlignment.centre,
            ...
            SizedBox(height: 16),
            Text('Contact Your Department For Further Details If Recovery Mail Not Found',
              style: TextStyle(
                fontSize: 13,
                fontWeight: FontWeight.bold,
              ),
  ...
  showDialog(
    ...
    builder: (BuildContext context) {
      return AlertDialog(
        ...
        content: Text('Verification code sent to $email. Please check your mail.'),
        actions: [
          TextButton(
            onPressed: () {
