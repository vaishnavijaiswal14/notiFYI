...
class StarredImagesAdminPage extends StatelessWidget {
                          ...
                          IconButton(
                            ...
                            onPressed: () {
                              // Handle link icon tap
                                    _showEventDetails(context, starredCategoryNames[index], starredEventDates[index]);
                            },
                          ),
                        ],
                      ),
  ...
  void _showEventDetails(BuildContext context, String categoryName, String eventDate) {
    showDialog(
      context: context,
